    ...
    <div className="bg-slate-100 py-2 text-slate-700 xs:py-4 lg:portrait:py-6 landscape:py-4">
      ...
      <div className="mx-2 md:mx-6 landscape:mx-6">
        <div className="font-thin text-slate-700 xl:landscape:mb-4">
          <div className=" mb-2 flex items-center justify-start text-base md:text-2xl smallTab:mb-4 smallTab:text-3xl lg:portrait:text-4xl xl:landscape:text-xl">
            <h2 className="flex items-center justify-center">
              Feel <span className="ml-1 font-black"> free</span>
            </h2>
            <h2 className="ml-1 font-thin">to contact me!</h2>
          </div>
          <p className="ml-2 pr-1 text-xs leading-5 tracking-wider md:text-base smallTab:text-lg lg:portrait:text-xl xl:landscape:text-base">
        ...
        <div className="flex-row-reverse xl:landscape:flex">
          <div className="my-4 mx-5 flex-wrap items-center justify-evenly text-slate-700 md:my-5 md:flex smallTab:my-6 lg:portrait:my-10 landscape:flex lg:landscape:mx-20 xl:landscape:mx-0 xl:landscape:my-0 xl:landscape:ml-6 xl:landscape:w-1/2 xl:landscape:flex-col xl:landscape:flex-nowrap xl:landscape:items-start xl:landscape:justify-start xl:landscape:px-20 xl:landscape:py-0 xl:landscape:pt-8">
          ...
          <div className="md:mx-14 xl:landscape:mx-0 xl:landscape:ml-2 xl:landscape:w-1/2">
            <ContactBox />
          </div>
        </div>
      </div>

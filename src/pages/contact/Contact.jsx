    ...
    <div className="bg-slate-100 py-2 text-slate-700 xs:py-4 lg:portrait:py-6 landscape:py-4">
      ...
      <div className="mx-2 md:mx-6 landscape:mx-6">
        <div className="font-thin text-slate-700">
          <div className=" mb-2 flex items-center justify-start text-base md:text-2xl smallTab:mb-4 smallTab:text-3xl lg:portrait:text-4xl">
            <h2 className="flex items-center justify-center">
              Feel <span className="ml-1 font-black"> free</span>
            </h2>
            <h2 className="ml-1 font-thin">to contact me!</h2>
          </div>
          <p className="ml-2 pr-1 text-xs leading-5 tracking-wider md:text-base smallTab:text-lg lg:portrait:text-xl">
        ...
        <div className="my-4 mx-5 flex-wrap items-center justify-evenly text-slate-700 md:my-5 md:flex smallTab:my-6 lg:portrait:my-10 landscape:flex lg:landscape:mx-20">
          <div className="icon mb-2 ml-10 flex items-center text-4xl md:ml-0 md:text-5xl smallTab:text-6xl lg:portrait:mb-4 lg:portrait:text-7xl landscape:ml-0">
            <GoMailRead />

            <div className="ml-4 cursor-pointer py-2 text-base duration-300 ease-in-out hover:scale-110 md:text-lg smallTab:text-xl lg:portrait:text-2xl">
              <Mailto
          ...
          <div className="icon mb-2 ml-10 flex items-center text-4xl md:text-5xl smallTab:text-6xl lg:portrait:mb-4 lg:portrait:text-7xl landscape:ml-0">
            <BsTelephone />
            <div className="ml-4 cursor-pointer py-2 text-base duration-300 ease-in-out hover:scale-110 md:text-lg smallTab:text-xl lg:portrait:text-2xl">
          ...
          <div className="icon mb-2 ml-10 flex items-center text-4xl md:ml-0 md:text-5xl smallTab:text-6xl  lg:portrait:text-7xl landscape:ml-0">
            <FaLinkedin />
            <div className="ml-4 cursor-pointer py-2 text-base duration-300 ease-in-out hover:scale-110 md:text-lg smallTab:text-xl lg:portrait:text-2xl">

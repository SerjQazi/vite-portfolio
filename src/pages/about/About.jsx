  ...
  return (
    <div className="bg-slate-100 py-2 text-slate-700 xs:py-4 lg:portrait:py-6 landscape:min-h-[94.4vh] landscape:py-4">
      ...
      <div className="textContainer mx-2 md:mx-6 landscape:mx-6">
        <div className="mb-2 items-center justify-start text-sm font-light leading-5 xs:mb-4 xs:flex xs:text-sm sm:text-base md:text-xl smallTab:text-2xl lg:portrait:mb-6 lg:portrait:text-[1.7rem] landscape:mb-4">
          <h2 className=" ">
      ...
      <div className=" ">
        <div className="mb-4 px-2 xs:mb-5 md:px-6 lg:portrait:mb-7 landscape:mb-4 landscape:px-6">
          ...
          <div className="landscape:flex">
            <div className="mb-4 flex items-center pl-2 landscape:mb-0 landscape:pl-0">
              <div className="logo flex w-20 items-center justify-center md:w-[5.5rem] smallTab:w-[6.5rem] lg:portrait:w-[8.5rem] phone:landscape:w-20 lg:landscape:w-[30%]">
                <img src={webIcon} alt="" />
              </div>

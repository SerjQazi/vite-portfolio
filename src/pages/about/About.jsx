  ...
  return (
    <div className="bg-slate-100 py-2 text-slate-700 xs:py-4 lg:portrait:py-6 landscape:py-4 ipad:landscape:py-6 2xl:landscape:py-6 3xl:landscape:py-10">
      ...
      <div className="textContainer mx-2 md:mx-6 landscape:mx-6 xl:landscape:mx-6 ipad:landscape:mx-16 2xl:landscape:mx-6 3xl:landscape:mx-16">
        <div className="mb-2 items-center justify-start text-sm font-light leading-5 xs:mb-4 xs:flex xs:text-sm sm:text-base md:text-xl smallTab:text-2xl xl:text-xl lg:portrait:mb-6 lg:portrait:text-[1.7rem] landscape:mb-4 ipad:landscape:mb-8 ipad:landscape:text-3xl 2xl:landscape:mb-6 2xl:landscape:text-2xl 3xl:landscape:mb-8 3xl:landscape:text-3xl">
          <h2 className=" ">
      ...
      <div className="flex-row-reverse xl:flex ipad:landscape:mx-10 ">

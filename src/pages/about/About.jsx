  ...
  return (
    <div className="bg-slate-100 py-2 text-slate-700 xs:py-4 lg:portrait:py-6 landscape:py-4">
      ...
      <div className="textContainer mx-2 md:mx-6 landscape:mx-6">
        <div className="mb-2 items-center justify-start text-sm font-light leading-5 xs:mb-4 xs:flex xs:text-sm sm:text-base md:text-xl smallTab:text-2xl xl:text-xl lg:portrait:mb-6 lg:portrait:text-[1.7rem] landscape:mb-4">
          <h2 className=" ">
      ...
      <div className="flex-row-reverse xl:flex ">
        <div className="mb-4 px-2 xs:mb-5 md:px-6 xl:w-1/2 lg:portrait:mb-7 landscape:mb-4 landscape:px-6 xl:landscape:mb-0 xl:landscape:py-4">
          <h3 className="mb-2 text-lg font-bold md:mb-4 md:text-xl smallTab:text-2xl lg:portrait:text-[1.65rem] xl:landscape:text-xl">
            What I Do?
          </h3>

          <div className="xl:flex-col landscape:flex">
            <div className="mb-4 flex items-center pl-2 landscape:mb-0 landscape:pl-0 xl:landscape:mb-5">

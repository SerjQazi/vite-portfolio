...
const Skills = () => {
  return (
    <div className="py-2 xs:py-4 landscape:py-4">
      <div className="mx-20 mb-4 flex items-center justify-center border-2 border-dashed border-slate-400 border-opacity-50 md:mx-32 md:mb-6 smallTab:mx-36 lg:portrait:mx-52 landscape:mb-2 phone:landscape:mb-4 lg:landscape:mx-44 lg:landscape:mb-6 ">

  ...
  return (
    <div className="py-2 xs:py-4 landscape:py-4">
      <div className="mx-20 mb-4 flex items-center justify-center border-2 border-dashed border-slate-400 border-opacity-50 landscape:mb-2 phone:landscape:mb-4 ">
        <h3 className="py-1 text-lg font-bold uppercase tracking-[0.35em] text-yellow-500">
          Skills
        </h3>
      </div>
      ...
      <div className="text-xl text-yellow-500">
        <ul className="grid grid-cols-4 tracking-wider landscape:grid-cols-6">
          <li className="mb-3 flex flex-col items-center justify-center landscape:text-xl">
            <FaReact />
            <p className="mt-2 text-center text-xs font-thin text-slate-100 landscape:mt-3">
              React
            </p>
          </li>
          <li className="mb-3 flex flex-col items-center justify-center landscape:text-xl">

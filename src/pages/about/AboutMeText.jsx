...
const AboutMeText = () => {
  return (
    <div className="mb-4 font-thin text-slate-700 xs:mb-5 lg:portrait:mb-7 landscape:mb-4 2xl:landscape:mb-6">
      ...
      <p className="hidden text-xs leading-5 tracking-wide md:text-sm md:leading-6 landscape:block lg:landscape:text-base xl:landscape:text-sm 2xl:landscape:text-base ">

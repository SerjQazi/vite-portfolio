...
const Resume = () => {
  return (
    <div className="text-slate-700">
      ...
      <div className="">
        <div className="text-slate-700">
          <p className="mb-1 text-base md:text-lg smallTab:text-xl lg:portrait:mb-2 lg:portrait:text-2xl">
            Juno College Of Technology
          </p>

          <p className="ml-2 flex items-center justify-start text-xs xs:text-sm md:text-base smallTab:text-lg lg:portrait:text-xl">

...
const Resume = () => {
  return (
    <div className="text-slate-700">
      ...
      <h3 className="mb-2 mt-4 text-lg font-bold uppercase">Education</h3>

      <div className="">
        <div className="text-slate-700">
          <p className="mb-1 text-base">Juno College Of Technology</p>

          <p className="ml-2 flex items-center justify-start text-xs xs:text-sm">

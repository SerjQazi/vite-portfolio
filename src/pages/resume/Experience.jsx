    ...
    <div className="text-slate-700">
      ...
      <div className="xl:landscape:flex">
        <div className="mb-4 lg:portrait:mb-7 xl:landscape:mb-0 xl:landscape:w-1/2">
          <h4 className="mb-0.5 text-base font-medium md:text-lg smallTab:text-xl lg:portrait:text-2xl xl:landscape:text-lg">
            INTERMEDIATE FRONTEND DEVELOPER
          </h4>
          <p className="mb-1 text-sm font-light md:text-base smallTab:text-lg lg:portrait:mb-4 lg:portrait:text-xl xl:landscape:text-base">
            Bank of Montreal - BMO
          </p>

          <ul className="text-xs md:text-sm smallTab:text-base lg:portrait:text-lg xl:landscape:text-sm">
            ...
            <li className="ml-0 mt-2 lg:portrait:mt-4">
              <p className="text-sm font-bold md:text-base smallTab:text-lg lg:portrait:text-xl xl:landscape:text-base">
                Tech Stack :
              </p>
              <p className="xs:text-x ml-2 flex items-center justify-start text-[0.7rem] leading-5 md:text-sm smallTab:text-base lg:portrait:text-lg xl:landscape:text-sm">
                &#x2022; React &#x2022; JavaScript &#x2022; HTML5 &#x2022;
                Tailwind &#x2022; RESTful API &#x2022; Bitbucket
              </p>
              <p className="ml-2 flex items-center justify-start text-[0.7rem] leading-5 xs:text-xs md:text-sm smallTab:text-base lg:portrait:text-lg xl:landscape:text-sm">

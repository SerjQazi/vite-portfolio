  ...
  return (
    <div className="bg-slate-100 py-2 text-slate-700 xs:py-4 landscape:min-h-[94.4vh] landscape:py-4">
      ...
      <div className="mx-2 md:mx-6 landscape:mx-6">
        <div className="bookSearch mb-4 flex items-center justify-center lg:landscape:mb-6">
          <div className="projectlogo w-20 md:portrait:w-[5.5rem] landscape:w-[5.5rem] lg:landscape:w-[7.5rem]">
          ...
          <div className="projectInfo ml-4 w-80 md:mr-0 md:portrait:ml-6 md:portrait:w-[25rem] landscape:ml-6 landscape:w-[25rem] lg:landscape:ml-8 lg:landscape:w-[35rem]">
            ...
            <div className="buttonContainer mt-4 flex text-sm lg:landscape:text-lg">
        ...
        <div className="roboTrivia mb-4 flex items-center justify-center lg:landscape:mb-6">
          <div className="projectlogo w-20 md:portrait:w-[5.5rem] landscape:w-[5.5rem] lg:landscape:w-[7.8rem]">
            <img src={robot} alt="" />
          </div>
        ...
        <div className="findMyBeer mb-4 flex items-center justify-center lg:landscape:mb-6">
          <div className="projectlogo w-20 md:portrait:w-[5.5rem] landscape:w-[5.5rem] lg:landscape:w-[7.8rem]">
            <img src={beer} alt="" />
          </div>

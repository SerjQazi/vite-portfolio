  ...
  return (
    <div className="flex flex-wrap items-center justify-center landscape:flex-nowrap ">
      ...
      <div className="portraitContainer w-full landscape:w-[87.5%] phone:landscape:w-[87%]">
        <img
          className="w-full object-cover md:portrait:h-[50vh] lg:portrait:h-[58.4vh] phone:landscape:h-[94.5vh] lg:landscape:h-auto xl:landscape:h-[90vh] ipad:landscape:h-[45.5rem] 2xl:landscape:h-[90vh] 3xl:landscape:h-[45.5rem]"
          src={selfPortrait}
          alt=""
        />
      </div>

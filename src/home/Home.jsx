  ...
  return (
    <div className="flex flex-wrap items-center justify-center landscape:flex-nowrap ">
      <div className="leftContainer flex w-full">
        <div className="textContainer pt-2 pl-2 xs:pt-6 xs:pl-6 md:portrait:pl-10 md:portrait:pt-10 landscape:pl-4 landscape:pt-2 phone:landscape:pt-0 phone:landscape:pl-8 lg:landscape:pl-8 ipad:landscape:pl-10">
          <div className="header font-sans font-black uppercase text-slate-700">
            <h3 className="text-lg leading-4 md:portrait:text-2xl phone:landscape:text-xl phone:landscape:leading-5 lg:landscape:text-3xl">
              Hi There!
            </h3>
            <div className=" mb-2 flex md:portrait:mb-4 lg:landscape:mb-4 ">
              <h2 className="text-2xl md:portrait:text-4xl phone:landscape:text-3xl lg:landscape:text-4xl ipad:landscape:text-5xl">
                I'M
              </h2>
              <h1 className="ml-2 font-cursive text-2xl text-yellow-500 md:portrait:text-4xl phone:landscape:text-3xl lg:landscape:text-4xl ipad:landscape:text-5xl">
                Serj Qazi
              </h1>
            </div>

            <h3 className="mb-2 w-fit bg-yellow-500 px-2.5 py-0.5 text-sm xs:mb-4 md:portrait:py-1 md:portrait:px-4 md:portrait:text-base ipad:landscape:px-3 ipad:landscape:py-1 ipad:landscape:text-lg">
              Frontend Developer
            </h3>
          </div>
          <div className="mb-4 text-xs font-thin leading-5 text-slate-700 xs:mb-6 xs:leading-[1.32rem] md:portrait:mb-8 md:portrait:text-base md:portrait:leading-6 lg:portrait:text-lg landscape:mb-2 landscape:leading-[1.05rem] phone:landscape:mb-6 lg:landscape:text-base ipad:landscape:mb-10 ipad:landscape:text-lg">
            <p>
      ...
      <div className="portraitContainer w-full landscape:w-[87.5%] phone:landscape:w-[87%]">
        <img
          className="w-full object-cover portrait:h-[50.1vh] xs:portrait:h-[49.5vh] md:portrait:h-[45.5vh] lg:portrait:h-[58.4vh] phone:landscape:h-[94.5vh] lg:landscape:h-auto"
          src={selfPortrait}
          alt=""
        />
      </div>

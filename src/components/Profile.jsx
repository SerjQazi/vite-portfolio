...
const Profile = () => {
  ...
  return (
    ...
    <div className=" landscape:flex landscape:h-[94.5vh] lg:landscape:h-[75vh]">
      ...
      <div className="pageContainer w-full landscape:h-auto landscape:w-[82%] landscape:overflow-auto">
        <Routes>
